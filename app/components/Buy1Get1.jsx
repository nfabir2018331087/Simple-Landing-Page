export default function Buy1Get1(){
    ...
    return (
        ...
        <h1 className="font-montserrat text-4xl pt-20 pl-6 md:pl-16 lg:pl-32 text-black font-semibold">BUY 1 GET 1 FREE</h1>
        <h1 className="font-montserrat text-4xl pt-2 pl-6 md:pl-16 lg:pl-32 font-semibold">
            ON <span className="font-semibold outline-text-black">BEST SELLING PRODUCTS</span>
        </h1>
